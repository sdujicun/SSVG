...
import weka.filters.timeseries.SubClassFilter;
 ...
 */
public class ShapeletTransformWithTrainDatasetSelected extends SimpleBatchFilter {
	 ...
	 */
	public ShapeletTransformWithTrainDatasetSelected() {
	 ...
	 * @param shapes
	 */
	public ShapeletTransformWithTrainDatasetSelected(ArrayList<Shapelet> shapes) {
		this();
	 ...
	 */
	public ShapeletTransformWithTrainDatasetSelected(int k) {
	 ...
	 */
	public ShapeletTransformWithTrainDatasetSelected(int k, int minShapeletLength, int maxShapeletLength) {
	 ...
	 */
	public ShapeletTransformWithTrainDatasetSelected(int k, int minShapeletLength, int maxShapeletLength, weka.core.shapelet.QualityMeasures.ShapeletQualityChoice qualityChoice) {
	 ...
	 * @throws Exception
	 */
	public static ShapeletTransformWithTrainDatasetSelected createFilterFromFile(String fileName) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static ShapeletTransformWithTrainDatasetSelected createFilterFromFile(String fileName, int maxShapelets) throws Exception {

		File input = new File(fileName);
		Scanner scan = new Scanner(input);
		scan.useDelimiter("\n");

		ShapeletTransformWithTrainDatasetSelected sf = new ShapeletTransformWithTrainDatasetSelected();
	...
	public static void trainTestExample(String problem) {
		try {
			...
			Instances sampleTrain = new SubClassFilter().process(train);
			//System.out.println(sampleTrain.numInstances() / 2);
			// use fold as the seed.
			// train = InstanceTools.subSample(train, 100, fold);
			ShapeletTransformWithTrainDatasetSelected transform = new ShapeletTransformWithTrainDatasetSelected();
			...
			transform.setNumberOfShapelets(sampleTrain.numInstances() / 2);
			transform.setQualityMeasure(QualityMeasures.ShapeletQualityChoice.INFORMATION_GAIN);
			long d1 = System.nanoTime();

			Instances tranTrain = transform.process(sampleTrain);
			...
			Logger.getLogger(ShapeletTransformWithTrainDatasetSelected.class.getName()).log(Level.SEVERE, null, ex);
		}
	}
}

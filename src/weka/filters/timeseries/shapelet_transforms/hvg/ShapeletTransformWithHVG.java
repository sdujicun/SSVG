 ...
 */
public class ShapeletTransformWithHVG extends SimpleBatchFilter {
	 ...
	 */
	public ShapeletTransformWithHVG() {
		this(DEFAULT_NUMSHAPELETS,  QualityMeasures.ShapeletQualityChoice.INFORMATION_GAIN);
	}
	 ...
	 * @param shapes
	 */
	public ShapeletTransformWithHVG(ArrayList<Shapelet> shapes) {
		this();
	 ...
	 */
	public ShapeletTransformWithHVG(int k) {
		this(k, QualityMeasures.ShapeletQualityChoice.INFORMATION_GAIN);
	}
	 ...
	 */
	public ShapeletTransformWithHVG(int k, weka.core.shapelet.QualityMeasures.ShapeletQualityChoice qualityChoice) {
		this.numShapelets = k;
	...
	public ArrayList<Shapelet> findBestKShapeletsCacheWithHVG(Instances data) {
		...
		for (int i = 0; i < list.size(); i++) {
			...
			seriesShapelets = searchFunction.SearchForShapeletsInSeriesWithHVG(data.get(dataSet), this::checkCandidate,this.minDiff);
	...
	public ArrayList<Shapelet> findBestKShapeletsCacheWithHVG(int numShapelets, Instances data) {
	 ...
	 * @throws Exception
	 */
	public static ShapeletTransformWithHVG createFilterFromFile(String fileName) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static ShapeletTransformWithHVG createFilterFromFile(String fileName, int maxShapelets) throws Exception {

		File input = new File(fileName);
		Scanner scan = new Scanner(input);
		scan.useDelimiter("\n");

		ShapeletTransformWithHVG sf = new ShapeletTransformWithHVG();
	 ...
	 * @throws Exception
	 */
	public long opCountForSingleShapeletWithHVG(Instances data) throws Exception {
		data = roundRobinData(data, null);
		subseqDistOpCount = 0;
		findBestKShapeletsCacheWithHVG(1, data);
...
//			System.out.println(accuracy + "\t");
			...
			Logger.getLogger(ShapeletTransformWithHVG.class.getName()).log(Level.SEVERE, null, ex);
		}
	}
}
